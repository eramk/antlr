// $ANTLR 3.3 Nov 30, 2010 12:46:29 com\\ericsson\\SearchQuery.g 2013-06-19 00:55:48
...
public class SearchQueryLexer extends Lexer {
    ...
    public final void mInt() throws RecognitionException {
        try {
            // com\\ericsson\\SearchQuery.g:87:3: ( '1' .. '9' ( Digit )* | '0' )
            int alt9=2;
            switch ( input.LA(1) ) {
            case '1':
            case '2':
            ...
            switch (alt9) {
                case 1 :
                    // com\\ericsson\\SearchQuery.g:87:6: '1' .. '9' ( Digit )*
                    {
                    matchRange('1','9'); 
                    // com\\ericsson\\SearchQuery.g:87:15: ( Digit )*
                    loop8:
                    do {
                        int alt8=2;
                        switch ( input.LA(1) ) {
                    ...
                    break;
                case 2 :
                    // com\\ericsson\\SearchQuery.g:88:6: '0'
                    {
                    match('0'); 
    ...
    public final void mDigit() throws RecognitionException {
        try {
            // com\\ericsson\\SearchQuery.g:92:3: ( '0' .. '9' )
            // com\\ericsson\\SearchQuery.g:92:6: '0' .. '9'
            {
            matchRange('0','9'); 
