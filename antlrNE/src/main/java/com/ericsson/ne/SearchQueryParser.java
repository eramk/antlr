// $ANTLR 3.3 Nov 30, 2010 12:46:29 com\\ericsson\\SearchQuery.g 2013-06-19 01:23:13
...
public class SearchQueryParser extends Parser {
    ...
    public final SearchQueryParser.exprList_return exprList() throws RecognitionException {
        ...
        try {
            ...
            // com\\ericsson\\SearchQuery.g:78:57: ( Comma | Space )*
            loop1:
            do {
                int alt1=2;
                switch ( input.LA(1) ) {
            ...
            // com\\ericsson\\SearchQuery.g:78:73: (e2= expression_enhanced )*
            loop2:
            do {
                int alt2=2;
                switch ( input.LA(1) ) {
                ...
                switch (alt2) {
            	case 1 :
            	    // com\\ericsson\\SearchQuery.g:78:74: e2= expression_enhanced
            	    {
            	    pushFollow(FOLLOW_expression_enhanced_in_exprList326);
    ...
    // com\\ericsson\\SearchQuery.g:81:1: expression returns [String scExp] : id= ID ( '-' Number )? ;
    public final SearchQueryParser.expression_return expression() throws RecognitionException {
        ...
        try {
            // com\\ericsson\\SearchQuery.g:82:3: (id= ID ( '-' Number )? )
            // com\\ericsson\\SearchQuery.g:82:5: id= ID ( '-' Number )?
            {
            root_0 = (Object)adaptor.nil();

            id=(Token)match(input,ID,FOLLOW_ID_in_expression353); 
            id_tree = (Object)adaptor.create(id);
            adaptor.addChild(root_0, id_tree);

            retval.scExp = id.getText(); 
            // com\\ericsson\\SearchQuery.g:83:3: ( '-' Number )?
            int alt3=2;
            switch ( input.LA(1) ) {
                case 14:
                    {
            ...
            switch (alt3) {
                case 1 :
                    // com\\ericsson\\SearchQuery.g:83:4: '-' Number
                    {
                    char_literal7=(Token)match(input,14,FOLLOW_14_in_expression360); 
                    char_literal7_tree = (Object)adaptor.create(char_literal7);
                    adaptor.addChild(root_0, char_literal7_tree);

                    Number8=(Token)match(input,Number,FOLLOW_Number_in_expression361); 
    ...
    // com\\ericsson\\SearchQuery.g:90:1: expression_enhanced returns [List scExpList] : id= ID ( '-' Number )? ;
    public final SearchQueryParser.expression_enhanced_return expression_enhanced() throws RecognitionException {
        ...
        try {
            // com\\ericsson\\SearchQuery.g:94:3: (id= ID ( '-' Number )? )
            // com\\ericsson\\SearchQuery.g:94:5: id= ID ( '-' Number )?
            {
            root_0 = (Object)adaptor.nil();

            id=(Token)match(input,ID,FOLLOW_ID_in_expression_enhanced392); 
            id_tree = (Object)adaptor.create(id);
            adaptor.addChild(root_0, id_tree);

            retval.scExpList.add(id.getText()); 
            // com\\ericsson\\SearchQuery.g:95:3: ( '-' Number )?
            int alt4=2;
            switch ( input.LA(1) ) {
                case 14:
                    {
            ...
            switch (alt4) {
                case 1 :
                    // com\\ericsson\\SearchQuery.g:95:4: '-' Number
                    {
                    char_literal9=(Token)match(input,14,FOLLOW_14_in_expression_enhanced399); 
                    char_literal9_tree = (Object)adaptor.create(char_literal9);
                    adaptor.addChild(root_0, char_literal9_tree);

                    Number10=(Token)match(input,Number,FOLLOW_Number_in_expression_enhanced400); 
    ...
    public static final BitSet FOLLOW_set_in_exprList312 = new BitSet(new long[]{0x0000000000003802L});
    public static final BitSet FOLLOW_expression_enhanced_in_exprList326 = new BitSet(new long[]{0x0000000000000802L});
    public static final BitSet FOLLOW_ID_in_expression353 = new BitSet(new long[]{0x0000000000004002L});
    public static final BitSet FOLLOW_14_in_expression360 = new BitSet(new long[]{0x0000000000000400L});
    public static final BitSet FOLLOW_Number_in_expression361 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ID_in_expression_enhanced392 = new BitSet(new long[]{0x0000000000004002L});
    public static final BitSet FOLLOW_14_in_expression_enhanced399 = new BitSet(new long[]{0x0000000000000400L});
    public static final BitSet FOLLOW_Number_in_expression_enhanced400 = new BitSet(new long[]{0x0000000000000002L});
